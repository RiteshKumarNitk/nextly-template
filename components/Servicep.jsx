  ...
  return (
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mb-9 rounded-[20px] bg-slate-700 p-10 shadow-2 hover:shadow-lg md:px-7 xl:px-10">
          <div className="mb-8 flex items-center justify-center rounded-full bg-primary w-24 h-24">
            {icon}
          </div>
          <h4 className="mb-[14px] text-2xl font-semibold text-white">
            {title}
          </h4>
          <p className="text-body-color text-dark-6">{details}</p>
        </div>
      </div>
    </>
  );
