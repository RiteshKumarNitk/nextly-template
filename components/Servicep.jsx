    ...
    <section className="container p-8 mx-auto xl:px-0 flex w-full flex-col mt-8 items-center justify-center text-center">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap -mx-4">
          <ServiceCard
            title="Benefits"
            details="To ensure product quality, compliance with safety regulations, and environmental sustainability, a factory's Quality, Safety, and Environment (QSE) inspection entails a detailed assessment of the manufacturing processes."
            icon={<BenefitsIcon />}
          />
          <ServiceCard
            title="Fields"
            details="The monthly scoring help in tracking progress, identifying areas for improvement, and making informed decisions based on the scored metrics."
            icon={<FieldsIcon />}
          />
          <ServiceCard
            title="Industries"
            details="Factory inspections serve as a critical cornerstone in safeguarding product quality, ensuring safety standards, and upholding compliance with regulations."
            icon={<IndustriesIcon />}
          />
        </div>
      </div>
...
const ServiceCard = ({ icon, title, details }) => {
  return (
    <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-9">
      <div className="h-full bg-gray-100 dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl">
        <div className="w-16 h-16 flex items-center justify-center rounded-full bg-primary mx-auto mb-3">
          {icon}
        </div>
        <h4 className="text-center text-2xl font-semibold  dark:text-white  mb-4">{title}</h4>
